"""
Django settings for jobflick project.
...
SECRET_KEY = 'django-insecure-g)21q*z7b!jq9t3=jj-cm_@^qf-2q0b(4kb=2-%1j!ezqr!9#%'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'userprofile.context_processors.unread_notifications',
            ],
        },
    },
]

WSGI_APPLICATION = 'jobflick.wsgi.application'
